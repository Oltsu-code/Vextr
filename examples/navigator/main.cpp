...
int main() {
    ...
    openBtn->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {80, 80, 160}, .bold = true});

    auto dialogBtn = std::make_shared<Button>("Open Dialog");
    dialogBtn->setStyle(Style{.fg = {255, 255, 255}, .bg = {40, 80, 40}});
    dialogBtn->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {80, 160, 80}, .bold = true});
    ...
    backBtn->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {100, 60, 140}, .bold = true});
    backBtn->setOnClick([&]() { nav->pop(); });

    settingsScreen->addChild(settingsTitle, {.fixedH = pct(15)});
    settingsScreen->addChild(backBtn,       {.fixedH = pct(10),
                                             .alignH = Align::Center,
                                             .alignV = Align::Center});

    // ── dialog overlay ───────────────────────────────────────────
    auto dialogOverlay = std::make_shared<Container>(
    ...
    confirmBtn->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {60, 120, 60}, .bold = true});
    ...
    cancelBtn->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {120, 60, 60}, .bold = true});
    ...
    btnRow->addChild(confirmBtn, {.ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center});
    btnRow->addChild(cancelBtn,  {.ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center});
    ...
    mainScreen->addChild(openBtn,    {.fixedH = pct(10),
                                      .alignH = Align::Center,
                                      .alignV = Align::Center});
    mainScreen->addChild(dialogBtn,  {.fixedH = pct(10),
                                      .alignH = Align::Center,
                                      .alignV = Align::Center});
