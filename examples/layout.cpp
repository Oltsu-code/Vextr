...
int main() {
    ...
    left->addChild(l2, { .ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center });
    left->addChild(l3, { .ratio = 1.0f, .alignH = Align::Start,  .alignV = Align::End });
    ...
    center->addChild(g4, {.alignH = Align::Center, .alignV = Align::Center, .col = 1, .row = 1 });
    center->addChild(g5, {.margin = MarginSpec::all(cells(1)), .col = 2, .row = 1 });
    ...
    auto rightMid = std::make_shared<Container>(
    ...
    right->addChild(rightBot, { .fixedH = pct(20), .alignH = Align::End, .alignV = Align::Center });
