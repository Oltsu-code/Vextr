...
int main() {
    ...
    auto header = std::make_shared<vextr::widgets::Label>("Tab to move focus  Enter to select  Q to quit");
    ...
    item1->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {60, 60, 120}, .bold = true});

    auto item2 = std::make_shared<FocusableLabel>("  Option 2");
    item2->setStyle(Style{.fg = {200, 200, 255}, .bg = {30, 30, 60}});
    item2->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {60, 60, 120}, .bold = true});

    auto item3 = std::make_shared<FocusableLabel>("  Option 3");
    item3->setStyle(Style{.fg = {200, 200, 255}, .bg = {30, 30, 60}});
    item3->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {60, 60, 120}, .bold = true});
    ...
    left->setFocusedStyle(Style{.fg = {255, 220, 100}, .bg = {80, 40, 120}, .bold = true});

    auto right = std::make_shared<FocusableLabel>("  Right panel");
    right->setStyle(Style{.fg = {200, 180, 255}, .bg = {40, 20, 60}});
    right->setFocusedStyle(Style{.fg = {255, 220, 100}, .bg = {80, 40, 120}, .bold = true});
