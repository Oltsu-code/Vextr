...
int main() {
    ...
    auto title = std::make_shared<Label>("Button demo — Tab to focus, Enter to click");
    ...
    btn1->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {80, 80, 160}, .bold = true});
    btn1->setOnClick([&]() {
    ...
    btn2->setFocusedStyle(Style{.fg = {255, 255, 100}, .bg = {80, 160, 80}, .bold = true});
    btn2->setOnClick([&]() {
    ...
    btn3->setFocusedStyle(Style{.fg = {255, 100, 100}, .bg = {160, 60, 60}, .bold = true});
    btn3->setOnClick([&]() {
        app.quit();
    });
    ...
    row->addChild(btn1, {.ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center});
    row->addChild(btn2, {.ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center});
    row->addChild(btn3, {.ratio = 1.0f, .alignH = Align::Center, .alignV = Align::Center});
