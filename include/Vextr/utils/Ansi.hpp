...
// cursor controls
inline std::string cursor(int row, int col) { return "\033[" + std::to_string(row) + ";" + std::to_string(col) + "H"; }
...
inline std::string move_right(int n)        { return "\033[" + std::to_string(n) + "C"; }
inline std::string move_left(int n)         { return "\033[" + std::to_string(n) + "D"; }
...
inline std::string clear_line_to_end()      { return "\033[K";  }   // clear from cursor to end of line
...
// 8 bit
inline std::string fg_8bit(int n)           { return "\033[38;5;" + std::to_string(n) + "m"; }
inline std::string bg_8bit(int n)           { return "\033[48;5;" + std::to_string(n) + "m"; }
