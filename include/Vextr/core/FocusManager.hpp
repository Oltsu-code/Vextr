...
/// @class FocusManager
/// @brief Manages focus among widgets, including traversal and event
/// dispatching
class FocusManager {
public:
...
private:
  ...
  /// Recursively traverses the widget tree to find all focusable widgets and
  /// adds them to the output vector.
  ///
